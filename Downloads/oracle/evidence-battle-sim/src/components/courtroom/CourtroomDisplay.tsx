...
export function CourtroomDisplay({ transcript, isLoading }: CourtroomDisplayProps) {
  ...
  return (
    <div className="flex flex-col bg-white rounded-xl shadow-lg h-full">
      {/* Header */}
      <div className="bg-gradient-to-r from-navy-800 to-navy-900 text-white px-8 py-5 rounded-t-xl flex-shrink-0">
      ...
      {/* Transcript Area - Scrollable with fixed height */}
      ...
      {/* Legend */}
      <div className="bg-gray-50 px-8 py-4 rounded-b-xl border-t border-gray-200 flex-shrink-0">
