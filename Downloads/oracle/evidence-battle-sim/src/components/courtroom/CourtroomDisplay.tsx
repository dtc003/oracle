...
export function CourtroomDisplay({ transcript, isLoading }: CourtroomDisplayProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg shadow-lg">
      {/* Header */}
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4 rounded-t-lg">
        <h2 className="text-2xl font-bold">Courtroom Transcript</h2>
        <p className="text-sm text-gray-300 mt-1">Live Examination</p>
      </div>
